...
def preprocess_dataset(data_path):
    image_list = []
    file_paths = []
    fetched_images = [os.path.join(root, f) for root, _, files in os.walk(data_path) for f in files if f.endswith('.jpg')]
...
datasets = {
    "finger_frac_test": "Data/Data/Hands&Forearms/testing/fractured",
    "finger_frac_train": "Data/Data/Hands&Forearms/training/fractured",
    "finger_frac_valid": "Data/Data/Hands&Forearms/validation/fractured",
    "finger_nfrac_test": "Data/Data/Hands&Forearms/testing/not_fractured",
    "finger_nfrac_train": "Data/Data/Hands&Forearms/training/not_fractured",
    "finger_nfrac_valid": "Data/Data/Hands&Forearms/validation/not_fractured"
}
